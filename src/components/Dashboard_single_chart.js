...
function Dashboard_single_chart({ dashboardId, defaultChartType, startColor, endColor, globalbackgroundColor, passDatasetMetadata }) {
...
export default Dashboard_single_chart;
